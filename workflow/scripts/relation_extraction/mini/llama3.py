...
if __name__ == '__main__':
    ...
    result = open_source_query(model_id="meta-llama/Meta-Llama-3-8B-Instruct",
                                      pubmed_abstracts=pubmed_abstracts, batch_size=4)


# Process results
    processed_result = process_result(result_df=result)

    # Ensure time_taken is preserved
    final_result = pd.concat((result, processed_result), axis=1)
