...
#get_api(
#        api_file = snakemake.params.api_file, header = snakemake.params.hf_api)
...
if mode == "few-shot":
    ...
    from utils.utils_llm_zero_shot_prompt_1 import open_source_query
...
if __name__ == '__main__':
    ...
    # result = open_source_query(model_id="mistralai/Mistral-Large-Instruct-2407",
    #                                   pubmed_abstracts=pubmed_abstracts, batch_size=2) # too big
    ...
    pubmed_abstracts['relation-extraction'] = final_result['answer_Mistral-Small-Instruct-2409_int']
    pubmed_abstracts.to_csv(snakemake.output.csv, index=False)
